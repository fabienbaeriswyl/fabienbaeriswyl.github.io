...
- _Palm versions and tail configurations of Hawkes processes_, projet en cours avec [Valérie Chavez-Demoulin](https://applicationspub.unil.ch/interpub/noauth/php/Un/UnPers.php?PerNum=1081431&LanCode=37) et [Olivier Wintenberger](http://wintenberger.fr). 
- _Hidden regular variation and sample-paths large deviations of some Poisson cluster processes_, projet en cours avec [Olivier Wintenberger](http://wintenberger.fr). 
